# Git is a Version Control System (VCS) a tool that helps us to keep track of differences in a file or collection of files over time. It can be used by different people who are working on the same 
